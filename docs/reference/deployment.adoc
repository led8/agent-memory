...
** Go to https://vercel.com[vercel.com] and sign in
...
image:https://vercel.com/button[Deploy with Vercel,link=https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fneo4j-labs%2Fneo4j-agent-memory&root-directory=neo4j-agent-memory/docs]
...
See xref:configuration.adoc[Configuration Reference] for all available settings.
...
. Verify the build copies it to `_site/style.css`
