...
Configure entity extraction for `add_memory`:
...
* xref:aws-bedrock-embeddings.adoc[Configure Bedrock Embeddings]
* xref:aws-hybrid-memory.adoc[Hybrid Memory Provider]
