...
| xref:first-agent-memory.adoc[Build Your First Memory-Enabled Agent]
...
| xref:conversation-memory.adoc[Add Conversation Memory to a Chatbot]
...
| xref:knowledge-graph.adoc[Build a Knowledge Graph from Documents]
...
| xref:microsoft-agent-memory.adoc[Build a Shopping Assistant with Microsoft Agent Framework]
| A retail shopping assistant that remembers preferences, uses graph algorithms for recommendations, and learns from past interactions.
| ~45 min
|===
